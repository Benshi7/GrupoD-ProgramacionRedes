...
export const QUESTIONS: Question[] = [
  // DNS & ARP Questions (Combined Module)
  {
    ...
    choices: [
      ...
      {
        id: 'b',
        label: 'Traduce nombres de dominio en direcciones IP',
        correct: true
      },
    ...
    explanation: {
      ...
      details: [
        ...
        'Ejemplo: al entrar a google.com o youtube.com, tu PC pregunta al DNS cuál es la IP de ese dominio y luego se conecta allí.'
      ],
  ...
  },
  {
    ...
    module: 'dns',
    prompt:
      '¿Qué tipos de servidores intervienen en la resolución de nombres DNS?',
    choices: [
      { id: 'a', label: 'Solo servidores locales' },
      {
        id: 'b',
        label: 'Servidores raíz, TLD, autoritativos y cachés',
        correct: true
      },
  ...
  },
  {
    ...
    choices: [
      ...
      {
        id: 'b',
        label: 'Para traducir direcciones IP en direcciones MAC',
        correct: true
      },
  ...
  // DHCP & STP Questions (Combined Module)
  {
    ...
    choices: [
      { id: 'a', label: 'Traduce nombres de dominio a direcciones IP' },
      {
        id: 'b',
        label:
          'Asigna automáticamente direcciones IP y otros parámetros de red',
        correct: true
      },
  ...
  },
  {
    ...
    choices: [
      ...
      {
        id: 'b',
        label: 'Evita bucles que generan tormentas de broadcast',
        correct: true
      },
  ...
  },
  {
    ...
    choices: [
      ...
      {
        id: 'b',
        label: 'Bloqueando automáticamente enlaces redundantes',
        correct: true
      },
  ...
  },
  {
    ...
    module: 'subnetting',
    prompt:
      '¿Cuál es la principal diferencia en el tamaño de direcciones entre IPv4 e IPv6?',
    choices: [
  ...
  },
  {
    ...
    choices: [
      ...
      {
        id: 'b',
        label: 'Para solucionar el agotamiento de direcciones IPv4',
        correct: true
      },
  ...
  },
  {
    ...
    module: 'subnetting',
    prompt:
      '¿Qué ventaja adicional ofrece IPv6 además del mayor espacio de direcciones?',
    choices: [
      { id: 'a', label: 'Menor consumo de energía' },
      {
        id: 'b',
        label: 'Seguridad mejorada y autoconfiguración',
        correct: true
      },
